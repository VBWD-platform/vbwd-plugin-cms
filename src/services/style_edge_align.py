...
EDGE_ALIGN_VERSION = "v1"
EDGE_ALIGN_START_MARKER = (
    "/* VBWD_EDGE_ALIGN:v1 — header nav, breadcrumb + content on one "
    "vertical line. Do not edit by hand. */"
)
EDGE_ALIGN_END_MARKER = "/* /VBWD_EDGE_ALIGN:v1 */"
...
_EDGE_ALIGN_CSS_LINES = (
    ...
    ".cms-breadcrumb, .cms-area--content .container {",
